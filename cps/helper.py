...
def convert_book_format(book_id, calibre_path, old_book_format, new_book_format, user_id, ereader_mail=None):
    ...
    if ereader_mail:
        ...
        settings['body'] = _('This Email has been sent via Bookbag.')
    else:
        settings = dict()
...
def send_test_mail(ereader_mail, user_name):
    for email in ereader_mail.split(','):
        ...
        WorkerThread.add(user_name, TaskEmail(_('Bookbag Test Email'), None, None,
...
def send_registration_mail(e_mail, user_name, default_password, resend=False):
    txt = "Hi %s!\r\n" % user_name
    if not resend:
        txt += "Your account in Bookbag has been created.\r\n"
    ...
    WorkerThread.add(None, TaskEmail(
        subject=_('Get Started with Bookbag'),
        filepath=None,
        attachment=None,
        settings=config.get_mail_settings(),
        recipient=e_mail,
        ...
        if entry.format.upper() == book_format.upper():
            ...
            for email in ereader_mail.split(','):
                ...
                WorkerThread.add(user_id, TaskEmail(_("Send to eReader"), book.path, converted_file_name,
                                 ...
                                 email_text, _('This Email has been sent via Bookbag.'), book.id))
            return
